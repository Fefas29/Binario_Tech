...
echo -e "\n[1] Cadastrando ocorrencia em scania..."
...
echo -e "\n[2] Cadastrando ocorrencia em Mercedes-Benz"
curl -s -X POST http://localhost:3000/api/v1/ocorrencias \
	-H "Content-Type: application/json" \
	-d '{"montadora": "Mercedes-Benz","placa":"MBB-1122","descricao":"Troca de pastilhas de freio","gravidade":"BAIXA"}' | jq .

echo -e "\n[3] Cadastrando ocorrencia em Jaguar"
curl -s -X POST http://localhost:3000/api/v1/ocorrencias \
	-H "Content-Type: application/json" \
	-d '{"montadora":"Jaguar","placa":"JGR-1892","descricao":"Falta de potencia","gravidade":"MEDIA"}' | jq .





echo -e "\n[4] Lendo arquivos JSON direto do disco (cat ocorrencias.json)..."
